...
class AnimeRepositoryTest {
    ...
    public void findByName_ReturnsListsOfAnime_WhenSuccessful(){
        Anime animeToBeSaved = AnimeCreator.createAnimeToBeSaved();
    ...
    @Test
    @DisplayName("Save throw anime ConstraintViolationException when name is empty")
    public void save_ThrowAnimeConstraintViolationException_WhenNameIsEmpty(){
